...
public:
    CyphalPublisher(CyphalNode* driver_, CanardPortID port_id_) : driver(driver_) {
        setPortId(port_id_);
...
struct HeartbeatPublisher: public CyphalPublisher {
    HeartbeatPublisher(CyphalNode* driver_) : CyphalPublisher(driver_, uavcan_node_Heartbeat_1_0_FIXED_PORT_ID_) {};
    void publish(const uavcan_node_Heartbeat_1_0& msg);
};

struct PortListPublisher: public CyphalPublisher {
    PortListPublisher(CyphalNode* driver_) : CyphalPublisher(driver_, uavcan_node_port_List_0_1_FIXED_PORT_ID_) {};
    void publish();
private:
